const HeartSVG = () => {
  return (
    <svg
      className="mt-4 w-5 mx-2 overflow-visible animated-heartbeat"
      viewBox="0 0 512 512"
      role="img"
  ...
  return (
    <footer className="flex flex-col py-8 border-t border-solid border-slate-300 justify-center items-center">
      <div className="text-xl font-bold">
        Made by
        {' '}
        <a rel="noopener noreferrer" target="_blank" href="https://paramshah.net" aria-label="Param Shah website"> Param Shah </a>
      </div>
      <div className="flex">
        <HeartSVG />
        <GithubSVG />
